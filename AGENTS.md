...
4. **Commit and push changes**:
   ...
   - Pushing the version tag triggers the `Release Desktop Installers` GitHub
     Actions workflow, which builds the Windows and universal macOS Tauri
     bundles and uploads the generated NSIS setup executable, MSI, and DMG to
